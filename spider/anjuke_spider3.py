...
if __name__ == '__main__':
    ...
    urls_1 = ['https://guangzhou.anjuke.com/sale/fanyu/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_2 = ['https://guangzhou.anjuke.com/sale/tianhe/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_3 = ['https://guangzhou.anjuke.com/sale/baiyun/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_4 = ['https://guangzhou.anjuke.com/sale/haizhu/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_5 = ['https://guangzhou.anjuke.com/sale/zengcheng/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_6 = ['https://guangzhou.anjuke.com/sale/huadu/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_7 = ['https://guangzhou.anjuke.com/sale/yuexiu/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_8 = ['https://guangzhou.anjuke.com/sale/huangpua/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_9 = ['https://guangzhou.anjuke.com/sale/nansha/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_10 = ['https://guangzhou.anjuke.com/sale/liwan/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_11 = ['https://guangzhou.anjuke.com/sale/conghua/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls_12 = ['https://guangzhou.anjuke.com/sale/guangzhouzhoubian/p' + str(i) + '/#filtersort' for i in range(1, 51)]
    urls = urls_1 + urls_2 + urls_3 + urls_4 + urls_5 + urls_6 + urls_7 + urls_8 + urls_9 + urls_10 + urls_11 + urls_12
    count = 0
    for url in urls:
        print('正在抓取：', url)
        wb = load_workbook("house3.xlsx")
        sheet = wb["house"]
        html = get_page(url)
